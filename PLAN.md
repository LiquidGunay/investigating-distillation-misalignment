...
Record overall elapsed time, Torch peak allocated/reserved memory, and actual free VRAM. Add phase instrumentation only to investigate an observed performance or memory failure.

Pass criteria:

- ten consecutive optimizer updates without OOM;
- at least 1.5 GiB of conservative measured VRAM headroom;
