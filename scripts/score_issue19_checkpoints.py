...
def summarize_scores(
    ...
    *,
    ...
    ordinary = margins["issue19_ordinary"]
    contrasts = {
...
def score_checkpoint(checkpoint: str, output_dir: Path) -> dict[str, Any]:
    import torch
    ...
    manifest = section["data"]["heldout_medical"]["splits"]["causal"]
...
def main() -> None:
    ...
    print(json.dumps(score_checkpoint(args.checkpoint, args.output_dir), indent=2, sort_keys=True))
